...
# Date: Fri, 15 Oct 2021 07:24:54 GMT
#set_units -time ns
...
create_generated_clock -name {I2C_1_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 33 65} [list [get_pins {ClockBlock/ff_div_2}]]
