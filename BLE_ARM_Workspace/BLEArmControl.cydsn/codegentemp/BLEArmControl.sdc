...
# Date: Tue, 19 Oct 2021 12:20:43 GMT
#set_units -time ns
...
create_generated_clock -name {UART_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 37 73} [list [get_pins {ClockBlock/ff_div_0}]]
