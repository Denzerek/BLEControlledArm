 ...
 */
#define CY_BLE_CUSTOMC_LED_SERVICE_INDEX   (0x00u) /* Index of LED service in the cy_ble_customCServ array */
#define CY_BLE_CUSTOMC_LED_GREEN_CHAR_INDEX   (0x00u) /* Index of GREEN characteristic */
#define CY_BLE_CUSTOMC_LED_GREEN_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
