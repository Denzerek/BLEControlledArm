...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x06u, 0x09u, 0x50u, 0x53u,
        0x6Fu, 0x43u, 0x36u, 0x11u, 0x07u, 0x41u, 0x2Fu,
        0xF8u, 0xD4u, 0x17u, 0xCDu, 0x2Bu, 0xA3u, 0xDAu,
        0x44u, 0xDBu, 0xBCu, 0x23u, 0x57u, 0x3Du, 0x84u,
...
(uint8_t)' ', (uint8_t)'f', (uint8_t)'r', (uint8_t)'o', (uint8_t)'m', (uint8_t)' ', (uint8_t)'0', (uint8_t)' ',
(uint8_t)'t', (uint8_t)'o', (uint8_t)' ', (uint8_t)'1', (uint8_t)'0', (uint8_t)'0', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Bu] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[21] }, /* GREEN */
    { 0x001Eu, (void *)&cy_ble_attValues[22] }, /* Characteristic User Description */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x13u] = {
    ...
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x000A0001u /* rd,wr */, 0x0013u, {{0x0010u, (void *)&cy_ble_attValuesLen[8]}} },
    { 0x0012u, 0xBDD8u /* GREEN                               */, 0x090A0101u /* rd,wr */, 0x0013u, {{0x0001u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd    */, 0x0013u, {{0x001Eu, (void *)&cy_ble_attValuesLen[10]}} },
};
