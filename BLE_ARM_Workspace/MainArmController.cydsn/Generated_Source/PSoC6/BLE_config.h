...
#define CY_BLE_MOTOR_M3_CHAR_INDEX   (0x02u) /* Index of M3 characteristic */
...
#define CY_BLE_MOTOR_M4_CHAR_INDEX   (0x03u) /* Index of M4 characteristic */
...
#define CY_BLE_MOTOR_M1_REL_CHAR_INDEX   (0x04u) /* Index of M1_REL characteristic */
#define CY_BLE_MOTOR_M1_REL_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_MOTOR_M2_REL_CHAR_INDEX   (0x05u) /* Index of M2_REL characteristic */
...
#define CY_BLE_MOTOR_M3_DECL_HANDLE   (0x0019u) /* Handle of M3 characteristic declaration */
#define CY_BLE_MOTOR_M3_CHAR_HANDLE   (0x001Au) /* Handle of M3 characteristic */
#define CY_BLE_MOTOR_M3_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x001Bu) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_MOTOR_M3_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x001Cu) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_MOTOR_M4_DECL_HANDLE   (0x001Du) /* Handle of M4 characteristic declaration */
#define CY_BLE_MOTOR_M4_CHAR_HANDLE   (0x001Eu) /* Handle of M4 characteristic */
#define CY_BLE_MOTOR_M4_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x001Fu) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_MOTOR_M4_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0020u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_MOTOR_M1_REL_DECL_HANDLE   (0x0021u) /* Handle of M1_REL characteristic declaration */
#define CY_BLE_MOTOR_M1_REL_CHAR_HANDLE   (0x0022u) /* Handle of M1_REL characteristic */
#define CY_BLE_MOTOR_M1_REL_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0023u) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_MOTOR_M2_REL_DECL_HANDLE   (0x0024u) /* Handle of M2_REL characteristic declaration */
#define CY_BLE_MOTOR_M2_REL_CHAR_HANDLE   (0x0025u) /* Handle of M2_REL characteristic */
#define CY_BLE_MOTOR_M2_REL_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0026u) /* Handle of Custom Descriptor descriptor */
