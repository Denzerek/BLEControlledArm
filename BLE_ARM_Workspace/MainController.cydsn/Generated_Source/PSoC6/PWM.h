...
#define PWM_RED_HW                 (PWM_TCPWM__HW)

/** This is a ptr to the base address of the TCPWM CNT instance */
#define PWM_RED_CNT_HW             (PWM_TCPWM__CNT_HW)

/** This is the counter instance number in the selected TCPWM */
#define PWM_RED_CNT_NUM            (PWM_TCPWM__CNT_IDX)
...
__STATIC_INLINE void PWM_DeInit(void)                   
{
    Cy_TCPWM_PWM_DeInit(PWM_RED_HW, PWM_RED_CNT_NUM, &PWM_config);
}
