...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_33 or Net_34 or Net_39)
        begin
            case (Net_39)
                1'b0 :  tmp__mux_1_reg = Net_33;
                1'b1 :  tmp__mux_1_reg = Net_34;
            endcase
        end
        assign Net_24 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    assign Net_25 = ~Net_39;

    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_1)
    begin
        cy_tff_1 <= Net_4^Net_39;
    end
    assign Net_39 = cy_tff_1;
    // -- TFF End --
