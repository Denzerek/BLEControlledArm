...
# Date: Tue, 12 Oct 2021 10:27:00 GMT
#set_units -time ns
...
create_generated_clock -name {Clock_1} -source [get_pins {ClockBlock/periclk}] -edges {1 13 25} [list [get_pins {ClockBlock/ff_div_11}] [get_pins {ClockBlock/ff_div_12}] [get_pins {ClockBlock/ff_div_20}]]
